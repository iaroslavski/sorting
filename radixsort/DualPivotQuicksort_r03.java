 ...
 * @since 1.7 * 14 ^ 22
 */
final class DualPivotQuicksort_r03 {
        ...
        while (true) {
            ...
            if (size < MAX_MIXED_INSERTION_SORT_SIZE + bits && (bits & 1) > 0) {
                sort(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET,
                        low, high, DualPivotQuicksort_r03::mixedInsertionSort);
                return;
            }
            ...
            if (size < MAX_INSERTION_SORT_SIZE) {
                sort(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET,
                        low, high, DualPivotQuicksort_r03::insertionSort);
                return;
            }
...
//          }
            ...
            if (a[e1] < a[e2] && a[e2] < a[e3] && a[e3] < a[e4] && a[e4] < a[e5]) {
                ...
                indices = partition(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET,
                        low, high, e1, e5, DualPivotQuicksort_r03::partitionWithTwoPivots);
                ...
                indices = partition(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET,
                        low, high, e3, e3, DualPivotQuicksort_r03::partitionWithOnePivot);
