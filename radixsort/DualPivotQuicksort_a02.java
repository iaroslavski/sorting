 ...
 * @since 1.7 * 14
 */
final class DualPivotQuicksort_a02 {

    /**
     * Prevents instantiation.
     */
    private DualPivotQuicksort_a02() {}
    ...
    static void sort(Sorter sorter, int[] a, int bits, int low, int high) {
        while (true) {
            ...
            if (size < MAX_MIXED_INSERTION_SORT_SIZE + bits && (bits & 1) > 0) {
                sort(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET, low, high, DualPivotQuicksort_a02::mixedInsertionSort);
                return;
            }
            ...
            if (size < MAX_INSERTION_SORT_SIZE) {
                sort(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET, low, high, DualPivotQuicksort_a02::insertionSort);
                return;
            }
            ...
            if (a[e1] < a[e2] && a[e2] < a[e3] && a[e3] < a[e4] && a[e4] < a[e5]) {
                 ...
                 */
                int[] pivotIndices = partition(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET, low, high, e1, e5, DualPivotQuicksort_a02::partitionDualPivot);
                 ...
                 */
                int[] pivotIndices = partition(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET, low, high, e3, e3, DualPivotQuicksort_a02::partitionSinglePivot);
                lower = pivotIndices[0];
                upper = pivotIndices[1];
                /*
...
// [long]
    ...
    static void sort(Sorter sorter, long[] a, int bits, int low, int high) {
        while (true) {
             ...
             */
            if (size < MAX_MIXED_INSERTION_SORT_SIZE + bits && (bits & 1) > 0) {
                sort(long.class, a, Unsafe.ARRAY_LONG_BASE_OFFSET, low, high, DualPivotQuicksort_a02::mixedInsertionSort);
                return;
            }
             ...
             */
            if (size < MAX_INSERTION_SORT_SIZE) {
                sort(long.class, a, Unsafe.ARRAY_LONG_BASE_OFFSET, low, high, DualPivotQuicksort_a02::insertionSort);
                return;
            }
            ...
            if (a[e1] < a[e2] && a[e2] < a[e3] && a[e3] < a[e4] && a[e4] < a[e5]) {
                 ...
                 * of tertiles. Note, that pivot1 < pivot2.
                 */
                int[] pivotIndices = partition(long.class, a, Unsafe.ARRAY_LONG_BASE_OFFSET, low, high, e1, e5, DualPivotQuicksort_a02::partitionDualPivot);
                lower = pivotIndices[0];
                upper = pivotIndices[1];
                /*
                 * Sort non-left parts recursively (possibly in parallel),
                 ...
                 * This value is inexpensive approximation of the median.
                 */
                int[] pivotIndices = partition(long.class, a, Unsafe.ARRAY_LONG_BASE_OFFSET, low, high, e3, e3, DualPivotQuicksort_a02::partitionSinglePivot);
                lower = pivotIndices[0];
                upper = pivotIndices[1];
                /*
                 * Sort the right part (possibly in parallel), excluding
...
// [float]
    ...
    static void sort(Sorter sorter, float[] a, int bits, int low, int high) {
        while (true) {
             ...
             */
            if (size < MAX_MIXED_INSERTION_SORT_SIZE + bits && (bits & 1) > 0) {
                sort(float.class, a, Unsafe.ARRAY_FLOAT_BASE_OFFSET, low, high, DualPivotQuicksort_a02::mixedInsertionSort);
                return;
            }
             ...
             */
            if (size < MAX_INSERTION_SORT_SIZE) {
                sort(float.class, a, Unsafe.ARRAY_FLOAT_BASE_OFFSET, low, high, DualPivotQuicksort_a02::insertionSort);
                return;
            }
            ...
            if (a[e1] < a[e2] && a[e2] < a[e3] && a[e3] < a[e4] && a[e4] < a[e5]) {
                 ...
                 * of tertiles. Note, that pivot1 < pivot2.
                 */
                int[] pivotIndices = partition(float.class, a, Unsafe.ARRAY_FLOAT_BASE_OFFSET, low, high, e1, e5, DualPivotQuicksort_a02::partitionDualPivot);
                lower = pivotIndices[0];
                upper = pivotIndices[1];
                /*
                 * Sort non-left parts recursively (possibly in parallel),
                 ...
                 * This value is inexpensive approximation of the median.
                 */
                int[] pivotIndices = partition(float.class, a, Unsafe.ARRAY_FLOAT_BASE_OFFSET, low, high, e3, e3, DualPivotQuicksort_a02::partitionSinglePivot);
                lower = pivotIndices[0];
                upper = pivotIndices[1];
                /*
                 * Sort the right part (possibly in parallel), excluding
...
// [double]
    ...
    static void sort(Sorter sorter, double[] a, int bits, int low, int high) {
        while (true) {
             ...
             */
            if (size < MAX_MIXED_INSERTION_SORT_SIZE + bits && (bits & 1) > 0) {
                sort(double.class, a, Unsafe.ARRAY_DOUBLE_BASE_OFFSET, low, high, DualPivotQuicksort_a02::mixedInsertionSort);
                return;
            }
             ...
             */
            if (size < MAX_INSERTION_SORT_SIZE) {
                sort(double.class, a, Unsafe.ARRAY_DOUBLE_BASE_OFFSET, low, high, DualPivotQuicksort_a02::insertionSort);
                return;
            }
            ...
            if (a[e1] < a[e2] && a[e2] < a[e3] && a[e3] < a[e4] && a[e4] < a[e5]) {
                ...
                * of tertiles. Note, that pivot1 < pivot2.
                */
                int[] pivotIndices = partition(double.class, a, Unsafe.ARRAY_DOUBLE_BASE_OFFSET, low, high, e1, e5, DualPivotQuicksort_a02::partitionDualPivot);
                lower = pivotIndices[0];
                upper = pivotIndices[1];
                /*
                 * Sort non-left parts recursively (possibly in parallel),
                 ...
                 * This value is inexpensive approximation of the median.
                 */
                int[] pivotIndices = partition(double.class, a, Unsafe.ARRAY_DOUBLE_BASE_OFFSET, low, high, e3, e3, DualPivotQuicksort_a02::partitionSinglePivot);
                lower = pivotIndices[0];
                upper = pivotIndices[1];
