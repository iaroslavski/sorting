...
public final class Main {
    ...
    public static void main(String[] args) {
        out("# Data type = short, Sorting type = " + (parallelism == 0 ? "sequential" : "parallel " + (parallelism + 1)) + ", Length = " + MAX_N);
...
//      new DPQKiller().kill(golden);
    ...
    private static void outArr(short[] a) {
    ...
    public static void copy(short[] src, short[] dst, int left, int right) {
        for (int i = left; i <= right; ++i) {
            dst[i] = src[i];
        }
    }
    ...
    public static void check(String name, short[] a1, short[] a2, int left, int right, boolean show) {
        for (int i = 0; i < LEFT; i++) {
...
//  private static int parallelism = 0;
    ...
    private static short[] save = new short[MAX_N];
    private static short[] test = new short[MAX_N];
