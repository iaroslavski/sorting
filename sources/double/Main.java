...
public final class Main {
    ...
    public static void main(String[] args) {
        out("# Data type = double, Sorting type = " + (parallelism == 0 ? "sequential" : "parallel " + (parallelism + 1)) + ", Length = " + MAX_N);
    ...
    private static void doIteration(String name) {
        ...
        doSort("jdk", new Sortable() { public void sortArray(double[] a) { DualPivotQuicksort_jdk   .sort(a, parallelism, LEFT, HIGH ); }});
        doSort("new", new Sortable() { public void sortArray(double[] a) { DualPivotQuicksort       .sort(a, parallelism, LEFT, HIGH ); }});
...
//      new DPQKiller().kill(golden);
    ...
    private static void permutation() {
        ...
        for (int i = MAX_N; i > 1; i--) {
            ...
            double t = golden[i - 1]; golden[i - 1] = golden[k]; golden[k] = t;
        }
    }
    ...
    private static void reverse(double[] a, int start, int hi) {
        hi--;
        while (start < hi) {
            double tmp = a[start];
            a[start++] = a[hi];
    ...
    public static void outArr(String name, double[] a) {
        out("\n" + name);
        outArr(a);
    }
    ...
    public static void outArr(double[] a, int left, int right) {
    ...
    public static void outArr(double[] a, int left, int high, boolean b) {
    ...
    public static void check(String name, double[] a1, double[] a2, int left, int right) {
        check(name, a1, a2, left, right, false);
    }

    public static void check(String name, double[] a1, double[] a2, int left, int right, boolean show) {
        String message;
...
//  private static int parallelism = ForkJoinPool.getCommonPoolParallelism();
    ...
    private static double[] golden = new double[MAX_N];
